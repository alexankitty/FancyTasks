...
MouseArea {
    ...
    PlasmaCore.FrameSvgItem {
        ...
        property Rectangle indicator: indicator
        Rectangle {
            id: indicator
        ...
        Colorize {
            ...
            anchors.fill: frame
            source: frame
            hue: hexToHSL(imageColors.dominant).h
            lightness: -0.2
            visible: frame.isHovered ? true : false
        }
    ...
    Loader {
        anchors.fill: frame
        asynchronous: true
        source: "IndicatorOverlay.qml"
        active: plasmoid.configuration.indicatorsEnabled
    }
